...
function Home() {
  ...
  return (
    <section className={`${s.home}  ${s.home_overlay}`} id="home">
          ...
          <div className={s.home_data}>
            ...
            <h1 className={s.home_title}>
              {language === "ES"
                ...
                : "We develop"}
                <span className={s.home_title_secondpart}> <span className={s.home_title_highlight}>IMPULSAR TU NEGOCIO.</span> </span>
            </h1>
            {/* <h3 className={s.home_subtitle}>
              {language === "ES"
            ...
            {language === "ES" ? (
              <p className={s.home_description}>
                Me especializo en desarrollar soluciones digitales
                personalizadas para{" "}
                <span className={s.home_highligth}>
                  impulsar el crecimiento de tu negocio
                </span>
                . Desde sitios web y ecommerce hasta software y aplicaciones
                móviles, nos enfocamos en{" "}
                <span className={s.home_highligth}>
                  crear experiencias digitales excepcionales que conectan con
                  tus clientes.
                </span>
              </p>
            ) : (
              <p className={s.home_description}>
                Developing{" "}
                <span className={s.home_highligth}>
                  intuitive websites and applications for mobile (iOS & Android)
                  and web
                </span>{" "}
                with exclusive designs, staying at the forefront of the latest
                technological trends.<br></br> Helping to{" "}
                <span className={s.home_highligth}>
